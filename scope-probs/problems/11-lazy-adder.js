...
/*function lazyAdder w/param firstNum
returns a function accepts secondNum
returns a function accepts thirdNum
...
// const lazyAdder = (num) => {
//   let sum = num;
//   return (innerFunc = (secondNum) => {
//     sum += secondNum;
//     return (innerFunc2 = (thirdNum) => {
//       sum += thirdNum;
//       return sum;
//     });
//   });
...
// const lazyAdder = num => innerFunc = (secondNum) => innerFunc2 = (thirdNum) => num + secondNum + thirdNum;
